...
func TestAccRealServiceListResource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccRealServiceListResourceConfig("one"),
			...
			{
				Config: testAccRealServiceListResourceConfig("two"),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func testAccRealServiceListResourceConfig(configurableAttribute string) string {
	return fmt.Sprintf(`
