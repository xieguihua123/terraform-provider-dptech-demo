...
func TestAccRealServiceResource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccRealServiceResourceConfig("one"),
			...
			{
				Config: testAccRealServiceResourceConfig("two"),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func testAccRealServiceResourceConfig(configurableAttribute string) string {
	return fmt.Sprintf(`
