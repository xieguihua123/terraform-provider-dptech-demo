...
func TestAccAddrPoolResource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccAddrPoolResourceConfig("one"),
			...
			{
				Config: testAccAddrPoolResourceConfig("two"),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func testAccAddrPoolResourceConfig(configurableAttribute string) string {
	return fmt.Sprintf(`
