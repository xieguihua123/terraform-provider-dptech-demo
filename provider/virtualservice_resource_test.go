...
func TestAccVirtualServiceResource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccVirtualServiceResourceConfig("one"),
			...
			{
				Config: testAccVirtualServiceResourceConfig("two"),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func testAccVirtualServiceResourceConfig(configurableAttribute string) string {
	return fmt.Sprintf(`
